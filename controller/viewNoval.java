 ...
 * @author Uchitachi
 */
public class viewNoval extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Chapter> chapters = cdb.getChapterInNoval(id);
        ...
        request.getRequestDispatcher("../client/noval.jsp").forward(request, response);
